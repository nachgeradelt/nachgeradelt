...
export default {
  ...
  created () {
    /**
     * Der Service OpenRouteService nutzt einen Api_Key um den Nutzer zu identifizieren.
     * Diese Key wird scheinbar nach 2500 Abfragen automatisch gelöscht.
     * Der Account bei OpenRouteService ist aktuell auf den Github-Account Iranox(https://github.com/Iranox)
     * registiert. 
    **/
    function getRoute46 () {
